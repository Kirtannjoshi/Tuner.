    ...
    <div style={{ display: 'flex', height: '100vh', width: '100vw', overflow: 'hidden' }}>
      ...
      <aside style={{
        ...
        <div style={{ marginTop: 'auto', paddingTop: 24, paddingLeft: 8, paddingRight: 8, borderTop: '1px solid var(--border-dim)' }}>
          ...
          <motion.a
            href="https://github.com/Kirtannjoshi/Tuner/releases/download/v1.0.0/app-debug.apk"
            target="_blank"
      ...
      <main style={{
        ...
        <header className="header-glass" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
            ...
            <a href="https://github.com/Kirtannjoshi/Tuner/releases/download/v1.0.0/app-debug.apk" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
              <motion.button
